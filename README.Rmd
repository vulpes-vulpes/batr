...
Use `species_names` to replace species codes with readable labels in the output.
...
Create custom report templates using RMarkdown. After installing batr, access the custom reports vignette with:
...
For details on accessing data objects and creating tailored analyses, see the vignette.
