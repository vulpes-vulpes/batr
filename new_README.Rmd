...
If anyone out there wants the old version (0.1.0) you can find it here [here](https://github.com/vulpes-vulpes/batr/releases/tag/v0.1.0) and the documentation [here](ADDME). Note that this version is hard-coded for Ontario bat species only.
